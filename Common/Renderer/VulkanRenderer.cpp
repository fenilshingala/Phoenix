...
struct Vertex
{
	...
	Vertex(glm::vec2 _pos, glm::vec3 _color)
	...
	{
		tinystl::vector<VkVertexInputAttributeDescription> attributeDescriptions(2);
...
{
	vertices.emplace_back( Vertex(glm::vec2(-0.5f, -0.5f), glm::vec3(1.0f, 0.0f, 0.0f)) );
	vertices.emplace_back( Vertex(glm::vec2(0.5f, -0.5f),  glm::vec3(0.0f, 1.0f, 0.0f)) );
	vertices.emplace_back( Vertex(glm::vec2(0.5f, 0.5f),  glm::vec3(0.0f, 0.0f, 1.0f)) );
	vertices.emplace_back( Vertex(glm::vec2(-0.5f, 0.5f), glm::vec3(1.0f, 1.0f, 1.0f)) );
...
void VulkanRenderer::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
{
	...
	// start recording temp command buffer
	VkCommandBufferBeginInfo beginInfo = {};
	beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
